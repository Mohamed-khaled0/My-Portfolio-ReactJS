...
import { SiTailwindcss, SiTypescript,  SiPostman, SiFlutter, SiDart } from 'react-icons/si';
import { 
  FaHtml5, 
  FaCss3Alt, 
  FaJs, 
...
const skillsData = [
  { name: 'Flutter', icon: <SiFlutter size={50} style={{ color: '#02569B' }} /> }, 
  { name: 'Dart', icon: <SiDart size={50} style={{ color: '#00BFFF' }} /> }, 
